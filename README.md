...
| CH5 | 低代码平台搭建 | 20 | 7 | Canvas 占位（可替换为 mp4 视频） |
...
| CH16 | 毕业设计 | 22 | 8 | Canvas 占位（可替换为 mp4 视频） |
...
- **视频动画**：CH5 和 CH16 动画位预留给视频（将 mp4 放入 `assets/animations/ch5/` 或 `assets/animations/ch16/` 即可自动启用，缺失时降级为 Canvas 占位提示）
